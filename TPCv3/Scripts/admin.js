$(function () {
    ...
    tpcBlog.GridManager.postsGrid = function (gridName, pagerName) {
        ...
        var addOptions = {
            ...
            onClose: onClose,
            afterSubmit: tpcBlog.GridManager.afterSubmitHandler,
    ...
    tpcBlog.GridManager.categoriesGrid = function (gridName, pagerName) {
    ...
    tpcBlog.GridManager.tagsGrid = function (gridName, pagerName) {
        var colNames = ['Id', 'Name', 'Url Slug', 'Description'];
    ...
    tpcBlog.GridManager.afterSubmitHandler = function (response, postdata) {
