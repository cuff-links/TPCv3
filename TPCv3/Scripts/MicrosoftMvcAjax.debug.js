...
Sys.Mvc.AsyncHyperlink.handleClick = function Sys_Mvc_AsyncHyperlink$handleClick(anchor, evt, ajaxOptions) {
    ...
    /// </param>
    evt.preventDefault();
    Sys.Mvc.MvcHelpers._asyncRequest(anchor.href, 'List', '', anchor, ajaxOptions);
};
////////////////////////////////////////////////////////////////////////////////
// Sys.Mvc.MvcHelpers
...
Sys.Mvc.AsyncForm.handleSubmit = function Sys_Mvc_AsyncForm$handleSubmit(form, evt, ajaxOptions) {
    ...
    Sys.Mvc.MvcHelpers._asyncRequest(form.action, form.method || 'List', body, form, ajaxOptions);
};
